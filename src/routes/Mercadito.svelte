			...
			>
				...
				<div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
					<div class="md:w-4/12 2xl:w-1/4 w-full">
						<img
							src="https://www.rockandpop.cl/wp-content/uploads/2021/04/164052645_2792562807659348_2182997092089222036_n-768x768.jpg"
				...
				<div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
					<div class="md:w-4/12 2xl:w-1/4 w-full">
						<img
							src="https://pbs.twimg.com/profile_images/1301245181304418305/3wi_j_E4_400x400.jpg"
							alt="Gray Sneakers"
							class="h-full object-center object-cover md:block hidden"
						/>
						<img
				...
				<div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
					<div class="md:w-4/12 2xl:w-1/4 w-full">
						<img
							src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvprQ3_qa991iQHLm2wkfaPq3mFI_8E6iqRg&usqp=CAU"
